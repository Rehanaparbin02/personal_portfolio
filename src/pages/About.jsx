    ...
    <div className="about-container">
      ...
      >
        <div className="hero-content">
          <h1 className="about-title">About Me</h1>
          <p className="about-intro cursive">
            Hi there, this is <span className="highlighted-name">Rehana Parbin</span> – a
            designer, developer, and creative thinker passionate about crafting digital
            experiences that feel effortless.
          </p>
          <p className="about-tagline">
            I believe great code comes from excellent design. From concept to deployment, I
            create digital products that work well and resonate.
          </p>
        </div>
      ...
      >
        <p className="about-text-large">
          ...
          <span className="highlighted-name">"Design First, Function Always"</span>, focuses
          on <span className="highlighted-name">learning</span> and{' '}
          <span className="highlighted-name">exploration</span>. I strive to create{' '}
          <span className="highlighted-name">elegant</span>,{' '}
          <span className="highlighted-name">efficient</span> code and{' '}
          <span className="highlighted-name">user-friendly experiences</span>. My process
          begins with <span className="highlighted-name">UI/UX prototyping</span> using{' '}
          <span className="highlighted-name">Figma</span> and{' '}
          <span className="highlighted-name">Webflow</span>, followed by the development of{' '}
          <span className="highlighted-name">high-performance front-end applications</span>{' '}
          in <span className="highlighted-name">React.js</span> and{' '}
          <span className="highlighted-name">React Native</span>. I am also devoted to
          building <span className="highlighted-name">dependable back-end systems</span>{' '}
          using <span className="highlighted-name">Node.js</span>,{' '}
          <span className="highlighted-name">Express.js</span>, and{' '}
          <span className="highlighted-name">PostgreSQL</span>/
          <span className="highlighted-name">Supabase</span>, as well as integrating{' '}
          <span className="highlighted-name">AI</span> and{' '}
          <span className="highlighted-name">machine learning</span> to enhance my digital
          products.
        </p>
      </div>
        ...
        >
          ...
          <div className="education-item hover-lift">
            <h3 className="degree-title">
              <span className="highlighted-name">Bachelor of Computer Science</span>
            </h3>
            <p className="institution">Barak Valley Engineering College</p>
            <p className="year">2019 - 2023</p>
          </div>
        ...
        >
          ...
          <ul className="about-skills-list">
            <li className="skill-item">
              <span className="highlighted-name">Web Design & Development</span>
            </li>
            <li className="skill-item">
              <span className="highlighted-name">UI/UX Design</span>
            </li>
            <li className="skill-item">
              <span className="highlighted-name">Brand Identity</span>
            </li>
            <li className="skill-item">
              <span className="highlighted-name">React & Modern JavaScript</span>
            </li>
            <li className="skill-item">
              <span className="highlighted-name">Responsive Design</span>
            </li>
            <li className="skill-item">
              <span className="highlighted-name">Node.js / Express.js</span>
            </li>
            <li className="skill-item">
              <span className="highlighted-name">RESTful APIs & GraphQL</span>
            </li>
            <li className="skill-item">
              <span className="highlighted-name">PostgreSQL / MongoDB / Supabase</span>
            </li>
            <li className="skill-item">
            ...
            <li className="skill-item">
              <span className="highlighted-name">Version Control (Git)</span>
            </li>
            <li className="skill-item">
              <span className="highlighted-name">Machine Learning</span>
            </li>
          </ul>
        </section>
      </div>
          ...
          <div className="tool-item hover-lift">
            <div className="tool-icon">
              <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                <path
                  fill="currentColor"
                  d="M100 0L150 50L100 100L50 50L100 0Z"
                />
                <path
                  fill="currentColor"
                  d="M50 50L100 100L50 150L0 100L50 50Z"
                />
                <path
                  fill="currentColor"
                  d="M150 50L200 100L150 150L100 100L150 50Z"
                />
                <path
                  fill="currentColor"
                  d="M100 100L150 150L100 200L50 150L100 100Z"
                />
              </svg>
            </div>
            <p className="tool-name">Webflow</p>
          ...
          <div className="tool-item hover-lift">
            <div className="tool-icon">
              <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path
                  fill="currentColor"
                  d="M3.59 7.36 2 8.74v6.52l1.59 1.38L9 12 3.59 7.36zM15 3l-8.94 8.17L15 19V3zM21 5v14l-2-.01V5L21 5z"
                />
              </svg>
            </div>
            <p className="tool-name">VS Code</p>
          ...
          <div className="tool-item hover-lift">
            <div className="tool-icon">
              <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                <path
                  fill="currentColor"
                  d="M100 432L256 80l156 352h-64l-92-224-92 224z"
                />
              </svg>
            </div>
            <p className="tool-name">Expo</p>
      ...
      {/* EXPERIENCE */}
      <section
        className={`about-card experience-card-full ${
          isVisible.experience ? 'reveal' : ''
        }`}
        data-section="experience"
      >
        <div className="card-header">
        ...
        <div className="experience-grid">
          <div className="experience-item hover-lift">
            ...
            <div className="experience-content">
              ...
              <p className="duration">Jun 2024 – Present</p>
              <p className="job-description">
                Designed and developed responsive, user-focused web and mobile apps for
                clients in retail and construction. Built scalable design systems and
                interactive prototypes in Figma, improving development handoff efficiency by
                40%. Implemented usability-first interfaces in React.js and React Native,
          ...
          <div className="experience-item hover-lift">
            ...
            <div className="experience-content">
              ...
              <p className="duration">Aug 2022 – Nov 2022</p>
              <p className="job-description">
                Conducted research on quantum-enhanced machine learning algorithms for
                computational optimization. Analyzed over 50+ academic papers and implemented
                performance improvements achieving 40% higher efficiency. Presented results
                to senior researchers and contributed to optimization models for
      ...
      {/* BEYOND WORK */}
      <section
        className={`about-card interests-card ${
          isVisible.interests ? 'reveal' : ''
        }`}
        data-section="interests"
      >
        <div className="card-header">
        ...
        <p className="about-text">
          When I'm not immersed in <span className="highlighted-name">code</span> or{' '}
          <span className="highlighted-name">design grids</span>, I turn to{' '}
          <span className="highlighted-name">sketching</span> – my quiet space to translate
          thoughts into lines and forms. I draw inspiration from{' '}
          <span className="highlighted-name">anime</span>, and I love watching{' '}
          <span className="highlighted-name">historical shows</span>,{' '}
          <span className="highlighted-name">documentaries</span>, and listening to{' '}
          <span className="highlighted-name">podcasts</span> across{' '}
          <span className="highlighted-name">various genres</span>. I enjoy exploring how{' '}
          <span className="highlighted-name">art</span>,{' '}
          <span className="highlighted-name">culture</span>, and{' '}
          <span className="highlighted-name">technology</span> mirror each other, constantly
          shaping the way we see and build the world. Those explorations often find their
          way back into my designs – as <span className="highlighted-name">emotion</span>,{' '}
          <span className="highlighted-name">balance</span>, and{' '}
          <span className="highlighted-name">rhythm</span>.
        </p>
      </section>

      {/* 🔥 PROCESS SECTION – unified UI + motion design */}
      <Process />
    </div>
  );
};
